...
This project investigates whether fossil occurrence within a **subset of the Morrison Formation in Colorado** can be predicted using geological and topographic features. The Morrison Formation (Late Jurassic) is one of the most fossil-rich sedimentary units in North America, particularly known for abundant dinosaur and vertebrate fossils.
